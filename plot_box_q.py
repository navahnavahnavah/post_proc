...
for ii in range(len(param_strings)):
    for iii in range(len(diff_strings)):
        ...
        sol_a[this_sol,:,ii,iii] = sol_full[1,this_sol,:,ii,iii]
        sol_b[this_sol,:,ii,iii] = sol_full[2,this_sol,:,ii,iii]
        sol_d[this_sol,:,ii,iii] = sol_a[this_sol,:,ii,iii] + sol_b[this_sol,:,ii,iii]
        ...
        alk_in_d[1:,ii,iii] = sol_d[3,1:,ii,iii] * (1.57e11)/((param_nums_time[ii])) * .00243
        alk_out_d[1:,ii,iii] = sol_d[3,1:,ii,iii] * (1.57e11)/((param_nums_time[ii])) * sol_d[2,1:,ii,iii] + 2.0*(sec_d[9,1:,ii,iii] - sec_d[9,:-1,ii,iii])
        alk_flux_d[:,ii,iii] = alk_out_d[:,ii,iii] - alk_in_d[:,ii,iii]

        alk_in_a[1:,ii,iii] = sol_a[3,1:,ii,iii] * (1.57e11)/((param_nums_time[ii])) * .00243
        alk_out_a[1:,ii,iii] = sol_a[3,1:,ii,iii] * (1.57e11)/((param_nums_time[ii])) * sol_a[2,1:,ii,iii] + 2.0*(sec_a[9,1:,ii,iii] - sec_a[9,:-1,ii,iii])
